...
const _WORLDS_META = [
  {
    ...
    sentences: ['I see a cat.', 'The sun is up.', 'A dog and a pig.'],
  ...
  },
  {
    ...
    sentences: ['The cat sat on the mat.', 'A big dog can run.', 'The hen is in the mud.'],
  ...
  },
  {
    ...
    sentences: ['The fish is on the ship.', 'I can see the moon.', 'Chad and Seth chat.'],
  ...
  },
  {
    ...
    sentences: ['I like to ride my bike.', 'The rain fell on the boat.', 'We came home late.'],
  ...
  },
  {
    ...
    sentences: ['They said we could play.', 'She wants to go there.', 'What do you see?'],
  ...
  },
  {
    ...
    sentences: ['The dragon sat on the sunset hill.', 'We can read big words now!', 'Riku is the best reader.'],
...
const _WORLD_STAGES = {
  ...
  1: [
    { name:"First Sound Forest", pattern:"First Sounds",
      ...
      activities:["oral-blend","first","letter-sound"], challengeEvery:2, miniName:"Sound Sprout", miniFile:"sound-sprout",
    ...
    { name:"Last Sound Lagoon", pattern:"Last Sounds",
      ...
      activities:["oral-blend","last","sound-count"], challengeEvery:2, miniName:"Echo Imp", miniFile:"echo-imp",
    ...
    { name:"Rhyme Rice Fields", pattern:"Rhyming Words",
      ...
      activities:["rhyme","oral-blend","sound-count"], challengeEvery:2, miniName:"Rhyme Sprite", miniFile:"rhyme-sprite",
    ...
    { name:"Letter Sound Trail", pattern:"Letter Sounds",
      ...
      activities:["letter-sound","oral-blend","first"], challengeEvery:2, miniName:"Glyph Goblin", miniFile:"glyph-goblin",
  ...
  2: [
    { name:"Short-A Arena", pattern:"Short-a CVC",
      ...
      activities:["segment-it","sound-count","middle"], miniName:"Paddy Pup", miniFile:"paddy-pup",
  ...
  _WORLDS_META.forEach((w) => {
    ...
    stageTables.forEach((st, sIdx) => {
      ...
      const stage = {
        ...
        // Decodable sentences — the world's Read-with-Riku capstone
        sentences: isBoss ? (w.sentences || []) : [],
        skyColor: w.skyColor,
