  ...
  },
  {
    ...
    languageOptions: {
      ...
      globals: {
        ...
        URLSearchParams: 'readonly', File: 'readonly', Blob: 'readonly',
  ...
  },
  {
    ...
    languageOptions: {
      ...
      globals: {
        ...
        CanvasRenderingContext2D: 'readonly', _slashGameInstance: 'readonly', PHONICS_DATA: 'readonly', createImageBitmap: 'readonly',
      },
    },
    rules: {
